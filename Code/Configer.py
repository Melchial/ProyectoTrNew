...
class Settings:
    def __init__(self):
        ...
        self.json = setting.get("Paths", "json")
    ...
    def createConfig(self):
        ...
        if file.find_directory("json"):
            self.config.set("Paths", "json", file.find_directory("json"))
        else:
            pathT = os.path.join(os.getcwd(),"json")
            os.mkdir(pathT)
            self.config.set("Paths", "json", pathT)
    ...
    def getUpdateInfo(self):
        ...
        self.json = self.setting.get("Paths", "json")
